        ...
        <head>
          ...
          <style>
            ...
            .label {
              ...
              padding: 2mm;
              text-align: center;
              height: ${297 / rows - 10}mm; /* Slightly tighter height */
              display: flex;
              flex-direction: column;
              justify-content: space-between; /* Changed from center to spread content */
              align-items: center;
              overflow: hidden;
            ...
            .barcode {
              ...
              font-size: 28pt; /* Slightly reduced to save space */
              line-height: 1;
              margin: 0;
            }
            .code-text {
